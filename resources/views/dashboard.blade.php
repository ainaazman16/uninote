    ...
    <div class="d-flex">
        ...
        <div id="mainContent" class="main-content flex-grow-1">
            ...
            @if (Auth::user()->role === 'provider')
                {{-- Role Indicator --}}
                <div class="alert alert-info d-flex align-items-center justify-content-between rounded-3 mb-4">
                    <div class="d-flex align-items-center gap-2">
                        <i class="bi bi-person-badge fs-4"></i>
                        <div>
                            <div class="fw-semibold">
                                You're a Provider viewing: <span class="badge bg-secondary">Student Dashboard</span>
                            </div>
...
@endif --}}
            ...
            <form action="{{ route('student.providers.search') }}" method="GET" class="mb-4">
                <div class="input-group">
                    <input type="text" name="query" class="form-control" placeholder="Search by provider name or email"
                        value="{{ request('query') }}">
