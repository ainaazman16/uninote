                                            ...
                                            <div class="modal-body text-center">
                                                ...
                                                @if (in_array(strtolower($ext), ['jpg', 'jpeg', 'png', 'webp']))
                                                    <img src="{{ asset('storage/' . $topup->proof_path) }}"
                                                        class="img-fluid rounded shadow" alt="Payment Proof">
                                                @elseif(strtolower($ext) === 'pdf')
                                                    <iframe src="{{ asset('storage/' . $topup->proof_path) }}" width="100%"
                                            ...
                                            <form action="{{ route('admin.wallet.topups.reject', $topup->id) }}"
                                                ...
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" name="rejection_reason" rows="4" placeholder="Enter reason for rejection..."
                                                            required></textarea>
                                                        <small class="text-muted">
