        ...
        <div class="col-lg-4 mb-4">
            <div class="card border-0 shadow-sm rounded-4 text-center h-100 overflow-hidden">
                ...
                <div class="card-body px-4 pb-5" style="margin-top: -60px;">
                    ...
                    <div class="mx-auto mb-3 p-1 bg-white rounded-circle shadow-sm" style="width: 130px; height: 130px;">
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm rounded-4 mb-4">
                <div class="card-body p-4 p-lg-5">
                    ...
                    <h5 class="fw-bold text-primary mb-4"><i class="bi bi-person-lines-fill me-2"></i>Academic Details</h5>
                    
                    <div class="row g-4 mb-5">
                        <div class="col-sm-6">
                            <div class="p-3 bg-light rounded-3 h-100 border border-light-subtle">
                                <small class="text-uppercase text-muted fw-bold" style="font-size: 0.75rem;">University</small>
                                <div class="fw-semibold text-dark mt-1">{{ $user->university ?? 'Not set' }}</div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="p-3 bg-light rounded-3 h-100 border border-light-subtle">
                                <small class="text-uppercase text-muted fw-bold" style="font-size: 0.75rem;">Programme</small>
                                <div class="fw-semibold text-dark mt-1">{{ $user->programme ?? 'Not set' }}</div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="p-3 bg-light rounded-3 h-100 border border-light-subtle">
                                <small class="text-uppercase text-muted fw-bold" style="font-size: 0.75rem;">Year of Study</small>
                                <div class="fw-semibold text-dark mt-1">{{ $user->year_of_study ?? 'Not set' }}</div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="p-3 bg-light rounded-3 h-100 border border-light-subtle">
                                <small class="text-uppercase text-muted fw-bold" style="font-size: 0.75rem;">Student ID</small>
                    ...
                    <div class="alert alert-light border rounded-3 mb-0 mt-2">
                        <div class="row g-3">
                            ...
                            <div class="col-12 text-end">
                                <small class="text-muted fst-italic">Applied on {{ $user->providerApplication->created_at->format('d M Y, h:i A') }}</small>
                            </div>
                        </div>
                    </div>
                </div>
